...
/*   Updated: 2021/12/08 18:46:47 by dhubleur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*read_and_stock(int fd, char *storage_buffer, int *status)
{
	char	*reading_buffer;
	int		readed;
...
char	*get_next_line(int fd, int *status)
{
	...
	storage_buffer[fd] = read_and_stock(fd, storage_buffer[fd], status);
